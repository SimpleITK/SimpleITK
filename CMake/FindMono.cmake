...
#
# The following variables are set: CSHARP_MONO_FOUND CSHARP_MONO_COMPILER_${version} eg. "CSHARP_MONO_COMPILER_2.10.2"
# CSHARP_MONO_INTERPRETOR_${version} eg. "CSHARP_MONO_INTERPRETOR_2.10.2" CSHARP_MONO_VERSION eg. "2.10.2"
# CSHARP_MONO_VERSIONS eg. "2.10.2, 2.6.7"
#
# Additional references can be found here: http://www.mono-project.com/Main_Page
# http://www.mono-project.com/CSharp_Compiler http://mono-project.com/FAQ:_Technical (How can I tell where the Mono
# runtime is installed)
#
# This file is based on the work of GDCM: http://gdcm.svn.sf.net/viewvc/gdcm/trunk/CMake/FindMono.cmake Copyright (c)
# 2006-2010 Mathieu Malaterre <mathieu.malaterre@gmail.com>
#

set(csharp_mono_valid 1)
if(DEFINED CSHARP_MONO_FOUND)
  # The Mono compiler has already been found It may have been reset by the user, verify it is correct
  if(NOT DEFINED CSHARP_MONO_COMPILER_${CSHARP_MONO_VERSION})
    ...
    set(CSHARP_MONO_VERSION
        ...
        CACHE STRING "C# Mono compiler version, choices: ${CSHARP_MONO_VERSIONS}" FORCE)
    message(
      FATAL_ERROR
...
if(WIN32)
  # Search for Mono on Win32 systems See http://mono-project.com/OldReleases and
  ...
  # TODO: Use HKLM_LOCAL_MACHINE\Software\Novell\Mono\DefaultCLR to specify default version get_filename_component( test
  ...
  foreach(csharp_mono_bin_dir ${csharp_mono_bin_dirs})
    ...
    if(csharp_mono_valid)
      ...
      set(CSHARP_MONO_COMPILER_${csharp_mono_version_temp}
          ${csharp_mono_executable}
          CACHE STRING "C# Mono compiler ${csharp_mono_version_temp}" FORCE)
    ...
    if(NOT DEFINED CSHARP_MONO_VERSIONS)
      ...
      set(CSHARP_MONO_VERSIONS
          "${CSHARP_MONO_VERSIONS}, ${csharp_mono_version_temp}"
          CACHE STRING "Available C# Mono versions" FORCE)
  ...
  if(EXISTS ${csharp_mono_compiler})
    ...
    if(EXISTS ${csharp_mono_interpreter})
      execute_process(COMMAND ${csharp_mono_interpreter} -V OUTPUT_VARIABLE csharp_mono_version_string)
      string(
        REGEX MATCH
              "([0-9]*)([.])([0-9]*)([.]*)([0-9]*)"
              csharp_mono_version_temp
