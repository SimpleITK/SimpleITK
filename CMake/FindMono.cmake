...
if(WIN32)
  ...
  foreach(csharp_mono_search_hint ${csharp_mono_search_hints})
    get_filename_component(
      csharp_mono_bin_dir
      "${csharp_mono_search_hint}"
      ABSOLUTE
    )
    if(EXISTS "${csharp_mono_bin_dir}")
      set(
        csharp_mono_bin_dirs
        ${csharp_mono_bin_dirs}
        ${csharp_mono_bin_dir}
      )
  ...
  foreach(csharp_mono_bin_dir ${csharp_mono_bin_dirs})
    ...
    if(csharp_mono_valid)
      ...
      set(
        ...
        ${csharp_mono_version_temp}
        CACHE STRING
        "C# Mono compiler version"
      )
      mark_as_advanced(CSHARP_MONO_VERSION)

      # Add variable holding executable
      set(
        CSHARP_MONO_COMPILER_${csharp_mono_version_temp}
        ${csharp_mono_executable}
        CACHE STRING
        "C# Mono compiler ${csharp_mono_version_temp}"
        FORCE
      )
      ...
      if(EXISTS "${csharp_mono_bin_dir}/mono.exe")
        set(
          CSHARP_MONO_INTERPRETER_${csharp_mono_version_temp}
          "${csharp_mono_bin_dir}/mono.exe"
          CACHE STRING
          "C# Mono interpreter ${csharp_mono_version_temp}"
          FORCE
        )
    ...
    if(NOT DEFINED CSHARP_MONO_VERSIONS)
      set(
        ...
        "${csharp_mono_version_temp}"
        CACHE STRING
        "Available C# Mono compiler versions"
        FORCE
      )
    ...
    set(
      ...
      1
      CACHE INTERNAL
      "Boolean indicating if C# Mono was found"
    )
  ...
  if(EXISTS ${csharp_mono_compiler})
    ...
    set(
      ...
      CACHE STRING
      "C# Mono compiler ${CSHARP_MONO_VERSION}"
      FORCE
    )
...
if(CSHARP_MONO_FOUND)
  ...
  message(
    STATUS
    "Found the following C# Mono versions: ${CSHARP_MONO_VERSIONS}"
  )
