...
if(DEFINED SimpleITK_4D_Image)
  message(
    WARNING
    "SimpleITK variable \"SimpleITK_4D_Image\" is \
...
set(
  "SimpleITK_MAX_DIMENSION"
  "${SimpleITK_MAX_DIMENSION_DEFAULT}"
  CACHE STRING
  "Add Image and I/O support up to max dimension (integer)."
)
...
if(NOT SimpleITK_MAX_DIMENSION MATCHES "^[0-9]+$")
  message(
    FATAL_ERROR
    "Expect \"SimpleITK_MAX_DIMENSION\" as an integer but got \"${SimpleITK_MAX_DIMENSION}\"."
  )
elseif(SimpleITK_MAX_DIMENSIONS LESS 3)
  message(
    FATAL_ERROR
    "The minimum  supported value for \"SimpleITK_MAX_DIMENSION\" is 3."
  )
endif()
