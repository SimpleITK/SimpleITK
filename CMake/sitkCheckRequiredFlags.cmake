#
# Sets the following variables: SimpleITK_PRIVATE_COMPILE_OPTIONS SimpleITK_PUBLIC_COMPILE_OPTIONS
#
# In particular, this marks the "-std=", and the "-stdlib=" as required, if present and check if c++11 is needed.
...
if(MSVC)
  # /bigobj is required for windows builds because of the size of some object files (CastImage for instance) Also
  # supress the pesky warning about std::vector not being marked for export in the dll
  list(
    APPEND
...
#
# Search CMAKE_CXX_FLAGS for flags that should be considered required, and propagated to other projects, via the
...
set(required_flags_regex_to_test "^-stdlib=" "^-std=" # required to be last
)
...
#
# Let the user set the CXX_STANDARD via these CMake variable, although it is preferred to set it in the CXX_FLAGS, as it
# will be propagated to SimpleITK's public compile options.
#
