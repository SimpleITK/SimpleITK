...
if(DEFINED CSHARP_DOTNET_FOUND)
  ...
  if(NOT DEFINED CSHARP_DOTNET_COMPILER_${CSHARP_DOTNET_VERSION})
    ...
    set(
      ...
      CACHE STRING
      "C# .NET compiler version, choices: ${CSHARP_DOTNET_VERSIONS}"
      FORCE
    )
    message(
      FATAL_ERROR
...
file(
  GLOB_RECURSE csharp_dotnet_executables
  "${csharp_dotnet_framework_dir}/csc.exe"
)
...
foreach(csharp_dotnet_executable ${csharp_dotnet_executables})
  if(csharp_dotnet_valid)
    ...
    set(
      CSHARP_DOTNET_COMPILER_${csharp_dotnet_version_temp}
      ${csharp_dotnet_executable}
      CACHE STRING
      "C# .NET compiler ${csharp_dotnet_version}"
      FORCE
    )
  ...
  if(NOT DEFINED CSHARP_DOTNET_VERSIONS)
    set(
      ...
      "${csharp_dotnet_version_temp}"
      CACHE STRING
      "Available C# .NET compiler versions"
      FORCE
    )
  else()
    set(
  ...
  set(
    ...
    1
    CACHE INTERNAL
    "Boolean indicating if C# .NET was found"
  )
...
if(CSHARP_DOTNET_FOUND)
  ...
  message(
    STATUS
    "Found the following C# .NET versions: ${CSHARP_DOTNET_VERSIONS}"
  )
...
set(
  DotNetFrameworkSdk_USE_FILE
  ${current_list_path}/UseDotNetFrameworkSdk.cmake
)
