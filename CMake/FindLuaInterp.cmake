...
# ::
#
# LUA_EXECUTABLE     - the full path to lua LUA_EXECUTABLE_FOUND          - If false, don't attempt to use lua
# LUA_EXECUTABLE_VERSION_STRING - version of lua found

set(_NAMES lua)

if(NOT
   LuaInterp_FIND_VERSION_MAJOR
   EQUAL
   0)
  list(
    INSERT
    _NAMES
    0
    lua${LuaInterp_FIND_VERSION_MAJOR})
  if(NOT
     LuaInterp_FIND_VERSION_MINOR
     EQUAL
     0)
    list(
      INSERT
...
find_package_handle_standard_args(
  ...
  VERSION_VAR LUA_EXECUTABLE_VERSION ${_args})
