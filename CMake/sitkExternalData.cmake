...
if(DEFINED SimpleITK_SOURCE_DIR AND EXISTS "${SimpleITK_SOURCE_DIR}/.ExternalData")
  ...
  list(APPEND ExternalData_OBJECT_STORES "${SimpleITK_SOURCE_DIR}/.ExternalData")
endif()
...
# Tell ExternalData commands not to transform raw files to content links. set(ExternalData_LINK_CONTENT MD5)

# Match series of the form <base>.<ext>, <base>.<n>.<ext> such that <base> may end in a (test) number that is not part
# of any series numbering.
