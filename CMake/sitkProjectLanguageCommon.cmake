foreach(p CMP0156 # De-duplicate libraries on link lines based on linker capabilities.
)
  if(POLICY ${p})
...
# Since most language libraries are not installed with CMake, the RPATH does not get fixed up during installation. So
# skip the RPATH
...
if(NOT TARGET dist)
  add_custom_target(
    ...
    -E
    echo
    "Finished generating wrapped package for distribution...")
endif()

# TODO these should be moved into UseSimpleITK
if(NOT SimpleITK_DOC_FILES)
  set(SimpleITK_DOC_FILES "${SimpleITK_SOURCE_DIR}/LICENSE" "${SimpleITK_SOURCE_DIR}/NOTICE"
...
set(SimpleITK_WRAPPING_COMMON_DIR ${SimpleITK_SOURCE_DIR}/Wrapping/Common)
...
list(APPEND SWIG_EXTRA_DEPS "${SimpleITK_WRAPPING_COMMON_DIR}/SimpleITK_Common.i")

# check if uint64_t is the same as unsigned long
try_compile(SITK_ULONG_SAME_AS_UINT64 "${PROJECT_BINARY_DIR}" ${SimpleITK_SOURCE_DIR}/CMake/same_uint64_ulong.cxx)
