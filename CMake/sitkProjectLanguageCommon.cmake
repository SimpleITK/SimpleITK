...
if(NOT CMAKE_PROJECT_NAME STREQUAL "SimpleITK")
  ...
  if(BUILD_TESTING)
    ...
    configure_file(
      "${SimpleITK_SOURCE_DIR}/CMake/CTestCustom.cmake.in"
      CTestCustom.cmake
    )
  endif()
...
find_package(SWIG 4.3.0...<5 REQUIRED)
...
if(CMAKE_PROJECT_NAME STREQUAL "SimpleITK")
  ...
  find_file(
    _file
    NAMES
      SimpleITKBasicFiltersGeneratedHeaders.h
    PATHS
...
set(
  ...
  -I${SimpleITK_WRAPPING_COMMON_DIR}
  ${CMAKE_SWIG_GLOBAL_FLAGS}
)
