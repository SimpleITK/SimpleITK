...
# check_compiler_warning_flags(<c_flags_var> <cxx_flags_var>) <c_flags_var> - variable to store valid C warning flags
# <cxx_flags_var> - variable to store valid CXX warning flags This internally calls the check_c_compiler_flag and
# check_cxx_compiler_flag macros.

# To create a portable build system, it is best to not test for platforms, but to test for features.
#
# Instead of testing "if Windows then do this", test for "if the -Wno-invalid-offsetof flag works then use it". You can
# do that with the CheckCCompilerFlag module, for example:

include(CheckCCompilerFlag)
include(CheckCXXCompilerFlag)

#
# this functions loops through the list to add the flags supported by the current compiler
...
# On windows, the most verbose compiler options is reporting 1000's of wanings in windows header files, for now, limit
# the number of warnings to level 3
if(WIN32)
  set(VerboseWarningsFlag -W3)
  # A better solution would be to use -Wall, and then disable warnings one by one set(VerboseWarningsFlag -Wall -wd4820
  # -wd4682 )
else()
