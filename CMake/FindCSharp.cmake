...
set(
  ...
  "anycpu"
  CACHE STRING
  "C# target platform: x86, x64, anycpu, or itanium"
)
...
if(CSHARP_DOTNET_FOUND)
  ...
  set(
    ...
    ""
    CACHE INTERNAL
    "Interpretor not required for .NET"
    FORCE
  )
elseif(CSHARP_MONO_FOUND)
  ...
  set(
    ...
    "/sdk:2"
    CACHE STRING
    "C# Mono SDK commandline switch (e.g. /sdk:2, /sdk:4, /sdk:5)"
  )
endif()
