...
# ------------
#
# Sets a CMake variable from an environment variable. If the environment variable is not defined then the existing CMake
# value will persist. Next if a "DEFAULT" argument is provided then the "value" parameter will be used to set the
# variable.
#
...
if(NOT
   ...
   OR NOT
      ...
      EQUAL
      0)
  message(FATAL_ERROR "Build did not complete without warnings, errors, or failures.")
