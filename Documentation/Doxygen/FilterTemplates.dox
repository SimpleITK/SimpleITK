...
- \b name: (\e string) This must be the name of the ITK filter.

- \b template_code_filename: (\e string) Which of the template files should be
...
- \b briefdescription: (\e string) Brief description of the class
  ...
  be modified. This field is maintained with the JSONDocUpdate.sh script.
...
- \b itk_module: (\e string) A string naming the ITK module the filter
  originates from. If the ITK installation used for building SimpleITK does
  not have this named module then the filter will be omitted in SimpleITK. This filed
  is maintained JSONUpdateITKModules.py script.

- \b itk_group: (\e string) A string naming the ITK group the ITK filter originates.
...
- [OPTIONAL] \b filter_type: (\e string) Explicitly sets the
  FilterType used. This method overrides
...
custom method are:
  ...
  \b var_name in each of the parameter objects can be used in this body
...
- \b briefdescriptionSet/briefdescriptionGet: (\e string) Brief
  ...
  field is automatically generated from ITK's Doxygen for members that
...
- \b detaileddescriptionSet/detaileddescriptionGet: (\e string)
  ...
  functions. This field is automatically generated from ITK's Doxygen
...
- \b description: (\e string) Documentation to describe this specific test
