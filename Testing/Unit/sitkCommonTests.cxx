...
TEST(Logger, ContextMethods)
{
  ...
  logger.DisplayErrorText(
    "testfile.cpp", 42, "TestClass", reinterpret_cast<void *>(static_cast<uintptr_t>(0x12345678)), "Error message");
  logger.DisplayWarningText(
    "testfile.cpp", 43, "TestClass", reinterpret_cast<void *>(static_cast<uintptr_t>(0x12345678)), "Warning message");
  logger.DisplayGenericOutputText("testfile.cpp", 44, "Generic message");
  logger.DisplayDebugText(
    "testfile.cpp", 45, "TestClass", reinterpret_cast<void *>(static_cast<uintptr_t>(0x12345678)), "Debug message");
...
TEST(Logger, ContextMethodsWithITKLogger)
{
  ...
  logger.DisplayErrorText(
    "testfile.cpp", 100, "ITKTestClass", reinterpret_cast<void *>(static_cast<uintptr_t>(0xABCDEF00)), "ITK Error");
  logger.DisplayWarningText(
    "testfile.cpp", 101, "ITKTestClass", reinterpret_cast<void *>(static_cast<uintptr_t>(0xABCDEF00)), "ITK Warning");
  logger.DisplayGenericOutputText("testfile.cpp", 102, "ITK Generic");
  logger.DisplayDebugText(
    "testfile.cpp", 103, "ITKTestClass", reinterpret_cast<void *>(static_cast<uintptr_t>(0xABCDEF00)), "ITK Debug");
