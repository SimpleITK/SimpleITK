...
#if defined(WRAP_TCL)
TEST_F(Tcl,SimpleGaussian) {
  // Run the simple gaussian command line program
  std::string Script = dataFinder.GetSourceDirectory() + "/Examples/SimpleGaussian.tcl";
  std::string output = dataFinder.GetOutputFile ( "Tcl.SimpleGaussian.nrrd" );
  std::vector<std::string> CommandLine;
  
  CommandLine.push_back ( dataFinder.GetTclExecutable() );
