 ...
 */
class SITKCommon_EXPORT ComposeScaleSkewVersor3DTransform : public Transform
{
public:
  ...
  ComposeScaleSkewVersor3DTransform &
  operator=(const ComposeScaleSkewVersor3DTransform &);

  /** Name of this class */
  std::string
  GetName() const override
  {
    return std::string("ComposeScaleSkewVersor3DTransform");
  }
