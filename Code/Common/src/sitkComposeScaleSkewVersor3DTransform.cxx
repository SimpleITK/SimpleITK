...
ComposeScaleSkewVersor3DTransform::operator=(const ComposeScaleSkewVersor3DTransform & arg)
{
...
std::vector<double>
ComposeScaleSkewVersor3DTransform::GetCenter() const
{
...
std::vector<double>
ComposeScaleSkewVersor3DTransform::GetVersor() const
{
...
std::vector<double>
ComposeScaleSkewVersor3DTransform::GetTranslation() const
{
...
std::vector<double>
ComposeScaleSkewVersor3DTransform::GetScale() const
{
...
std::vector<double>
ComposeScaleSkewVersor3DTransform::GetSkew() const
{
  return this->m_pfGetSkew();
}

std::vector<double>
ComposeScaleSkewVersor3DTransform::GetMatrix() const
{
  return this->m_pfGetMatrix();
}

void
ComposeScaleSkewVersor3DTransform::SetPimpleTransform(std::unique_ptr<PimpleTransformBase> && pimpleTransform)
{
...
void
ComposeScaleSkewVersor3DTransform::InternalInitialization(itk::TransformBase * transform)
{
...
void
ComposeScaleSkewVersor3DTransform::InternalInitialization(TransformType * t)
{
