...
///
  ...
  protected:
    ...
    typename EnableIf<util::is_same<TPixelIDType, typename ImageTypeToPixelID<ImageType>::PixelIDType>::value
    ...
    template < typename TPixelIDType >
    typename DisableIf<util::is_same<TPixelIDType, typename ImageTypeToPixelID<ImageType>::PixelIDType>::value,
    ...
    template < typename TPixelIDType, typename TPixelType >
    typename DisableIf<util::is_same<TPixelIDType, typename ImageTypeToPixelID<ImageType>::PixelIDType>::value >::Type
    InternalSetPixel( const std::vector<uint32_t> &idx, const TPixelType &v ) const
      {
        Unused( idx );
        Unused( v );
