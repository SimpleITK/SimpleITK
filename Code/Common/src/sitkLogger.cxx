...
public:
                   ...
                   const char * message) override
  {
    if (m_That)
    {
      m_That->DisplayErrorText(file, line, className, objectAddress, message);
    }
    else
    {
                     ...
                     const char * message) override
  {
    if (m_That)
    {
      m_That->DisplayWarningText(file, line, className, objectAddress, message);
    }
    else
    {
                   ...
                   const char * message) override
  {
    if (m_That)
    {
      m_That->DisplayDebugText(file, line, className, objectAddress, message);
    }
    else
    {
  ...
  DisplayGenericOutputText(const char * file, unsigned int line, const char * message) override
  {
    if (m_That)
    {
      m_That->DisplayGenericOutputText(file, line, message);
    }
    else
    {
...
void
LoggerBase::DisplayErrorText(const char * file,
                             unsigned int line,
                             const char * className,
                             const void * objectAddress,
                             const char * message)
...
void
LoggerBase::DisplayWarningText(const char * file,
                               unsigned int line,
                               const char * className,
                               const void * objectAddress,
                               const char * message)
...
void
LoggerBase::DisplayGenericOutputText(const char * file, unsigned int line, const char * message)
{
  // Default implementation formats the message and calls the simple version
  std::ostringstream formattedMessage;
...
void
LoggerBase::DisplayDebugText(const char * file,
                             unsigned int line,
                             const char * className,
                             const void * objectAddress,
                             const char * message)
...
void
ITKLogger::DisplayErrorText(const char * file,
                            unsigned int line,
                            const char * className,
                            const void * objectAddress,
                            const char * message)
...
void
ITKLogger::DisplayWarningText(const char * file,
                              unsigned int line,
                              const char * className,
                              const void * objectAddress,
                              const char * message)
...
void
ITKLogger::DisplayGenericOutputText(const char * file, unsigned int line, const char * message)
{
  if (m_OutputWindow)
  {
...
void
ITKLogger::DisplayDebugText(const char * file,
                            unsigned int line,
                            const char * className,
                            const void * objectAddress,
                            const char * message)
