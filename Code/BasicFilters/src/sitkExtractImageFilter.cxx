...
Image ExtractImageFilter::ExecuteInternal ( const Image& inImage1 )
{
  ...
  using FilterType = itk::ExtractImageFilter<InputImageType, typename InputImageType::template Rebind<typename InputImageType::PixelType, (InputImageType::ImageDimension-1<2?2:InputImageType::ImageDimension-1)>::Type >;
