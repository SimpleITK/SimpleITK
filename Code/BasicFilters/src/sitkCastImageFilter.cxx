...
CastImageFilter::GetMemberFactory()
{
...
CastImageFilter::Execute(const Image & image)
{
  ...
  if (GetMemberFactory().HasMemberFunction(inputType, outputType, dimension))
  {
    return GetMemberFactory().GetMemberFunction(inputType, outputType, dimension, this)(image);
  }
