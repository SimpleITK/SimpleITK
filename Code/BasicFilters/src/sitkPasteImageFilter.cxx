...
PasteImageFilter::GetMemberFactory()
{
...
PasteImageFilter::GetMemberFactory2()
{
...
PasteImageFilter::Execute(const Image & destinationImage, const Image & sourceImage)
{
  ...
  {
    return GetMemberFactory().GetMemberFunction(type, dimension, this)(&destinationImage, &sourceImage);
  }
...
PasteImageFilter::Execute(const Image & destinationImage, double constant)
{
  ...
  if (GetMemberFactory2().HasMemberFunction(type, dimension))
  {
    return GetMemberFactory2().GetMemberFunction(type, dimension, this)(&destinationImage, constant);
  }
