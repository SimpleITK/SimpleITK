...
template <typename TImageType, typename TOutputImageType>
Image
CastImageFilter::ExecuteInternalToVector(const Image & inImage)
{
  ...
  sitkDebugMacro(<< "Executing ITK filters:" << std::endl << caster);
...
template <typename TImageType, typename TOutputImageType>
Image
CastImageFilter::ExecuteInternalToLabel(const Image & inImage)
{
  using InputImageType = TImageType;
  using OutputImageType = TOutputImageType;
...
template <typename TImageType, typename TOutputImageType>
Image
CastImageFilter::ExecuteInternalLabelToImage(const Image & inImage)
{
  using InputImageType = TImageType;
  using OutputImageType = TOutputImageType;
