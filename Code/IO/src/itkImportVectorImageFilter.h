 ...
 *
 *=========================================================================*/
#ifndef __itkImportVectorImageFilter_h
#define __itkImportVectorImageFilter_h
 ...
 *
 * ImportVectorImageFilter provides a mechanism for importing data into an itk::Image.
...
class ITK_EXPORT ImportVectorImageFilter:
  public ImageSource< VectorImage< TPixel, VImageDimension > >
{
public:
  /** Typedef for the output image.   */
  typedef VectorImage< TPixel, VImageDimension >      OutputImageType;
...
#include "itkImportVectorImageFilter.txx"
#endif
