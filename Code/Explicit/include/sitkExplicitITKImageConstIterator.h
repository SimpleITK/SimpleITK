...
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageConstIterator<itk::Image<itk::CovariantVector<double, 2u>, 2u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageConstIterator<itk::Image<itk::CovariantVector<double, 3u>, 3u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageConstIterator<itk::Image<itk::CovariantVector<float, 2u>, 2u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageConstIterator<itk::Image<itk::CovariantVector<float, 3u>, 3u>>;
