...
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageRegionConstIterator<itk::Image<itk::CovariantVector<double, 2u>, 2u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageRegionConstIterator<itk::Image<itk::CovariantVector<double, 3u>, 3u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageRegionConstIterator<itk::Image<itk::CovariantVector<float, 2u>, 2u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageRegionConstIterator<itk::Image<itk::CovariantVector<float, 3u>, 3u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageRegionConstIterator<itk::Image<itk::Vector<double, 1u>, 1u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageRegionConstIterator<itk::Image<itk::Vector<double, 2u>, 2u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageRegionConstIterator<itk::Image<itk::Vector<double, 3u>, 3u>>;
extern template class SITKExplicit_EXPORT_EXPLICIT
  itk::ImageRegionConstIterator<itk::Image<itk::Vector<float, 1u>, 3u>>;
...
// >; extern template class SITKExplicit_EXPORT_EXPLICIT itk::ImageRegionConstIterator<itk::VectorImage<unsigned char,
// 3u> >; extern template class SITKExplicit_EXPORT_EXPLICIT itk::ImageRegionConstIterator<itk::VectorImage<unsigned
// int, 2u> >; extern template class SITKExplicit_EXPORT_EXPLICIT
// itk::ImageRegionConstIterator<itk::VectorImage<unsigned int, 3u> >; extern template class
// SITKExplicit_EXPORT_EXPLICIT itk::ImageRegionConstIterator<itk::VectorImage<unsigned long, 2u> >; extern template
// class SITKExplicit_EXPORT_EXPLICIT itk::ImageRegionConstIterator<itk::VectorImage<unsigned long, 3u> >; extern
// template class SITKExplicit_EXPORT_EXPLICIT itk::ImageRegionConstIterator<itk::VectorImage<unsigned short, 2u> >;
