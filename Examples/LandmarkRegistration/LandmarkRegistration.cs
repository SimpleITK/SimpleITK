...
namespace itk.simple.examples
{
    class LandmarkRegistration
    {
        static void Main(string[] args)
        {
            ...
            pasteFilter.SetSourceIndex(new VectorUInt32(new uint[] {0, 0}));
            pasteFilter.SetDestinationIndex(new VectorUInt32(new uint[] {11, 11}));
            ...
            pasteFilter.SetDestinationIndex(new VectorUInt32(new uint[] {51, 51}));
