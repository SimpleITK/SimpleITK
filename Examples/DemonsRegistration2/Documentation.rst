...
This example illustrates how to use the `fast symmetric forces Demons algorithm <https://itk.org/SimpleITKDoxygen/html/classitk_1_1simple_1_1FastSymmetricForcesDemonsRegistrationFilter.html>`_. As the name implies, unlike the classical algorithm, the forces are symmetric.
