...
set(
  ...
  "http://itk.org/files/NightlyDoxygen/InsightDoxygenDocTag.gz"
)
...
if(EXISTS ${ITK_DOXYGEN_COMPRESSED_TAG_FILE})
  ...
  if(GZIP_TOOL)
    ...
    execute_process(
      COMMAND
        ${GZIP_TOOL} -df ${ITK_DOXYGEN_COMPRESSED_TAG_FILE}
      RESULT_VARIABLE GZIP_OUT
    )
    if(${GZIP_OUT})
      message(
        WARNING
    ...
    set(
      ...
      "${ITK_DOXYGEN_TAG_FILE}=https://www.itk.org/Doxygen/html/"
    )
  endif()
else()
