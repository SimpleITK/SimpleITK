...
if(BUILD_DOXYGEN)
  ...
  #
  # Add option to use ITK tags, will download during configuration time if needed.
  #

  option(USE_ITK_DOXYGEN_TAGS "Download ITK's Doxygen tags" ON)

  if(USE_ITK_DOXYGEN_TAGS)
    set(ITK_DOXYGEN_TAGFILE
        ""
        CACHE PATH "ITK Doxygen tag file location. Empty string automatically downloads.")
    ...
    set(ITK_DOXYGEN_ROOT_URL
        "https://www.itk.org/Doxygen/html/"
        CACHE STRING "URL for the ITK Doxygen web root")
  ...
  add_custom_command(
    OUTPUT "${PROJECT_BINARY_DIR}/Documentation/Doxygen/Examples.dox"
    COMMAND
      ${CMAKE_COMMAND} -D "PROJECT_SOURCE_DIR:PATH=${PROJECT_SOURCE_DIR}" -D
      "OUTPUT_FILE:PATH=${PROJECT_BINARY_DIR}/Documentation/Doxygen/Examples.dox" -P
  ...
  add_custom_command(
    OUTPUT "${PROJECT_BINARY_DIR}/Documentation/Doxygen/FilterCoverage.dox"
    COMMAND ${Python_EXECUTABLE} ${PROJECT_SOURCE_DIR}/Utilities/CSVtoTable.py --doxygen
            ${PROJECT_SOURCE_DIR}/Utilities/filters.csv ${PROJECT_BINARY_DIR}/Documentation/Doxygen/FilterCoverage.dox
  ...
  add_custom_target(
    Documentation
    COMMAND ${DOXYGEN_EXECUTABLE} ${PROJECT_BINARY_DIR}/Utilities/Doxygen/doxygen.config MAIN_DEPENDENCY
            ${PROJECT_BINARY_DIR}/Utilities/Doxygen/doxygen.config
    DEPENDS "${PROJECT_BINARY_DIR}/Documentation/Doxygen/Examples.dox"
    DEPENDS "${PROJECT_BINARY_DIR}/Documentation/Doxygen/FilterCoverage.dox" ${TAGS_DEPENDS}
