...
if(NOT PCRE2_DIR)
  ...
  configure_file(pcre2_configure_step.cmake.in ${CMAKE_CURRENT_BINARY_DIR}/pcre2_configure_step.cmake @ONLY)
  ...
  ExternalProject_Add(
    ...
    DEPENDS "${PCRE2_DEPENDENCIES}" ${External_Project_USE_ARCHIVE_TIMESTAMP})
