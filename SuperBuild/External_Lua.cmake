...
set(lua_PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_CURRENT_SOURCE_DIR}/lua.cmake
...
ExternalProject_Add(
  ...
  CMAKE_ARGS --no-warn-unused-cli
             -C
             "${lua_binary_dir}/CMakeCacheInit.txt"
             ${ep_common_args}
             -D
             BUILD_SHARED_LIBS:BOOL=OFF
             -D
             CMAKE_INSTALL_PREFIX:PATH=${lua_install_dir}
