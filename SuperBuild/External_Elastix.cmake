...
ExternalProject_Add(
  ...
  CMAKE_GENERATOR ${gen}
  CMAKE_ARGS
    -DCMAKE_TOOLCHAIN_FILE:FILEPATH=${CMAKE_TOOLCHAIN_FILE} --no-warn-unused-cli
    -C "${CMAKE_CURRENT_BINARY_DIR}/${proj}-build/CMakeCacheInit.txt"
    ${ep_common_args} ${ep_elastix_args} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}
    -DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=ON -DBUILD_TESTING:BOOL=OFF
    ...
    -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DITK_DIR:PATH=${ITK_DIR}
    ...
    -DUSE_AffineLogStackTransform:BOOL=ON -DUSE_AffineLogTransformElastix=ON
    -DUSE_BSplineInterpolator:BOOL=ON -DUSE_BSplineInterpolatorFloat:BOOL=ON
    ...
    -DUSE_CMAEvolutionStrategy:BOOL=OFF -DUSE_CUDAResampler:BOOL=OFF
    -DUSE_ConjugateGradient:BOOL=OFF -DUSE_ConjugateGradientFRPR:BOOL=OFF
    ...
    -DUSE_FixedGenericPyramid:BOOL=ON -DUSE_FixedRecursivePyramid:BOOL=ON
    -DUSE_FixedShrinkingPyramid:BOOL=ON -DUSE_FixedSmoothingPyramid:BOOL=ON
    -DUSE_FullSampler:BOOL=OFF -DUSE_FullSearch:BOOL=OFF
    -DUSE_GradientDifferenceMetric:BOOL=OFF -DUSE_GridSampler:BOOL=ON
    -DUSE_KNNGraphAlphaMutualInformationMetric:BOOL=OFF
    -DUSE_LinearInterpolator:BOOL=ON -DUSE_LinearResampleInterpolator:BOOL=ON
    -DUSE_MissingStructurePenalty:BOOL=OFF -DUSE_MovingGenericPyramid:BOOL=ON
    -DUSE_MovingRecursivePyramid:BOOL=ON -DUSE_MovingShrinkingPyramid:BOOL=ON
    ...
    -DUSE_NormalizedMutualInformationMetric:BOOL=ON -DUSE_PCAMetric:BOOL=ON
    -DUSE_PCAMetric2:BOOL=ON -DUSE_PatternIntensityMetric:BOOL=OFF
    -DUSE_PolydataDummyPenalty:BOOL=OFF -DUSE_Powell:BOOL=OFF
    -DUSE_QuasiNewtonLBFGS:BOOL=ON -DUSE_RSGDEachParameterApart:BOOL=OFF
    -DUSE_RandomCoordinateSampler:BOOL=ON -DUSE_RandomSampler:BOOL=ON
    -DUSE_RandomSamplerSparseMask:BOOL=ON -DUSE_RayCastInterpolator:BOOL=OFF
    ...
    -DUSE_SimilarityTransformElastix:BOOL=ON -DUSE_Simplex:BOOL=OFF
    -DUSE_SimultaneousPerturbation:BOOL=OFF -DUSE_SplineKernelTransform:BOOL=ON
    -DUSE_StandardGradientDescent:BOOL=ON -DUSE_StatisticalShapePenalty:BOOL=OFF
