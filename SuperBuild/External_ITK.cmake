...
set(_SimpleITK_DEFAULT_MODULES
...
set(ITK_GIT_REPOSITORY
    ...
    CACHE STRING "URL of ITK Git repository")
...
set(ITK_GIT_TAG
    ...
    CACHE STRING "Tag in ITK git repo")
...
if(ITK_GIT_TAG STREQUAL _DEFAULT_ITK_GIT_TAG)
  # While migrated to ITK 6.0 this is disabled list( APPEND ep_itk_args "-DITK_LEGACY_REMOVE:BOOL=ON" )
endif()
...
ExternalProject_Add(
  ...
  ${ITK_TAG_COMMAND}
  UPDATE_COMMAND "" ${ITK_INSTALL_COMMAND}
  SOURCE_DIR ${proj}
  ...
  DEPENDS ${${proj}_DEPENDENCIES} ${External_Project_USES_TERMINAL})
