...
if(DEFINED Swig_DIR AND NOT EXISTS ${Swig_DIR})
  message(
    FATAL_ERROR
    "Swig_DIR variable is defined but corresponds to non-existing directory"
  )
endif()
...
if(NOT SWIG_DIR)
  ...
  if(USE_SWIG_FROM_GIT)
    set(
      ...
      CACHE STRING
      "URL of swig git repo"
    )
    set(
      SWIG_GIT_TAG
      "v${SWIG_TARGET_VERSION}"
      CACHE STRING
      "Tag in swig git repo"
    )
  ...
  if(WIN32)
    ...
    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND APPLE)
      set(
        REQUIRED_CXX_FLAGS
        "${REQUIRED_CXX_FLAGS} -Wno-deprecated-declarations"
      )
